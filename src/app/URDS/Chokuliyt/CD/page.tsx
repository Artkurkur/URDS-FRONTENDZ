        ...
        <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
          <div className="flex items-start gap-4">
            ...
            <div className="flex-1">
              <h1 className="text-xl font-semibold text-gray-900">College Dean</h1>
              <div className="flex items-center gap-2 mt-1">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">Dr. Maria L. Santos • Dean, College of Engineering</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4 mt-6">
            ...
            >
              ...
              <div className="text-sm mt-1">Pending Dean Review</div>
            </button>
            <button 
            ...
            >
              ...
              <div className="text-sm mt-1">Dean Approved</div>
            </button>
            <button 
            ...
            >
              ...
              <div className="text-sm mt-1">Dean Rejected</div>
            </button>
          </div>
